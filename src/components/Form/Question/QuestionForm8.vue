      ...
      <el-row>
        <el-col :span="11" >
            <el-form-item label="处理机关">
              <el-input :readonly="readonlyStatus" v-model="questionForm.handling_organs"></el-input>
            </el-form-item>
        </el-col>
        <el-col :span="11" :offset="1">
          <el-form-item label="处理时间">
            <el-date-picker type="date" placeholder="选择日期" v-model="questionForm.handling_time" value-format="yyyy-MM-dd" style="width: 100%;" :readonly="readonlyStatus"></el-date-picker>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="23">
          <el-form-item label="违纪或违法事实">
            <el-input :readonly="readonlyStatus" type="textarea" :autosize="{ minRows: 3 }" v-model="questionForm.fact_type"></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
